...
use app\controller\DirController;
...
class Index extends BaseController
{
    ...
    public function view(DirController $dircontroller){
        $projectPath = '/'.trim(Config::get('dir.project_path'),'/').'/';
        // dump($projectPath);exit;
        $projectFloders = $dircontroller->getDirsInfo($projectPath);

        $projectFolder = trim(Config::get('dir.project_folder'),'/').'/';
        View::assign('projectFloders',$projectFloders);
